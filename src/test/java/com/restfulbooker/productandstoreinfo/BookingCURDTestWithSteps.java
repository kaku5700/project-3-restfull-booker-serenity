package com.restfulbooker.productandstoreinfo;


import com.restfulbooker.bookinginfo.AuthSteps;
...
public class BookingCURDTestWithSteps extends TestBase {
    ...
    static String lastname = TestUtils.getRandomValue() + "Patel";
    static int totalprice = 456;
    static boolean depositpaid = true;
    static String additionalneed = "Breakfast";
    ...
    @Test
    public void test006() {
        firstName = firstName + "Misha";
        lastname = lastname + "Misha";
